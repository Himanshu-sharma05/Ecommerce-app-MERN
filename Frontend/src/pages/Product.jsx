...
const Product = () => {
  ...
  return productData ? (
    ...
    <div className='border-5-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      {/*------- Product Data -------- */}
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>An e-commerce website is an online platform that facilitates the buying Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod, quasi?</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore unde velit sequi illo ad ex quidem veritatis. Architecto, commodi deserunt.</p>   
        </div>
      </div>
